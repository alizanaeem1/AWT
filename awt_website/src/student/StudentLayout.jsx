          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={profileRef}>
              <button
                ...
                className="flex items-center gap-2.5 rounded-xl border border-slate-200 bg-white py-1.5 pl-1.5 pr-3 transition hover:border-slate-300 hover:bg-slate-50 dark:border-slate-700/50 dark:bg-slate-900/60 dark:hover:border-slate-600 dark:hover:bg-slate-800"
              >
                {profile?.avatar_url ? (
              ...
              {isProfileOpen && (
                <div className="animate-scale-in absolute right-0 mt-2.5 w-56 overflow-hidden rounded-2xl border border-slate-200 bg-white/95 p-1.5 shadow-2xl shadow-black/10 backdrop-blur-md z-50 dark:border-slate-800/80 dark:bg-[#0b1422]/95 dark:shadow-black/40">
                  <div className="mb-1 rounded-xl bg-slate-100/80 px-3 py-3 dark:bg-slate-800/40">
                    <p className="text-sm font-black text-slate-900 dark:text-white">{profile?.full_name || (profile?.role === 'admin' ? 'Admin User' : 'Student')}</p>
                  ...
                  <Link to="/student/profile" onClick={() => setIsProfileOpen(false)} className="flex items-center gap-2.5 rounded-xl px-3 py-2 text-sm font-semibold text-slate-600 transition hover:bg-slate-100 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-slate-800/60 dark:hover:text-white">
                    <Settings className="h-4 w-4" />
                    Profile Settings
                  </Link>
